...
class ActionsInExcel:
    ...
    def actionOnLocator(self, locator_type, locator_value, action_name, *data):
        ...
        elif action_name == 'ACCEPT_ALERT':
            WebApplicationActionsObj.alertAccept()

        elif action_name == 'ACCEPT_DISMISS':
            WebApplicationActionsObj.alertDismiss()
        ...
        elif action_name == 'ACCEPT_JAVASCRIPT_ALERT':
            WebApplicationActionsObj.acceptAlert()
...
filepaths = CsvFileReader("D:\Work\Quivers Automation\WoocommerceAutomation\Shipment from woocom\Sanity.csv")
...
to_Emails = ['shubha.shukla@thoughts2binary.com']
